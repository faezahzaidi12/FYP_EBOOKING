...
const SUPABASE_URL = "https://supabase.com/dashboard/project/doyyrhhscdpchuvpancq"; 
...
const supabaseClient = createClient(https://supabase.com/dashboard/project/doyyrhhscdpchuvpancq, SUPABASE_ANON_KEY);
